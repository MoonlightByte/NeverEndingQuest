...
| `test_t040_combat_validation.py` | T040 (combat validation) | gpt-5.4 none/5.2 none/low, gemini-flash low/medium/high | gpt-5.4\|none=4/4 (SELECTED). gpt-5.2 fails. Requires v4 prompt. |
