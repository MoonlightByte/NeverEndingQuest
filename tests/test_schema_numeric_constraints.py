...
This test module covers:
  ...
  5. Encounter creature with currentHitPoints=0 -> fails
...
# ---------------------------------------------------------------------------
# Test 5: encounter creature with currentHitPoints=0 must fail.
# ---------------------------------------------------------------------------

def test_encounter_with_zero_current_hitpoints_fails(encounter_schema):
    ...
    msg = str(exc.value).lower()
    assert "currenthitpoints" in msg or "minimum" in msg or "0" in msg, (
