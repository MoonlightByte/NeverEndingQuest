...
print("\n  [PASS] Essential save succeeds: PASS")
print("  [PASS] Archive not created: PASS")
print("  [PASS] Legacy content-only shape: PASS")
print("  [PASS] No archive dependency: PASS")
...
print("\n  [PASS] Different outcomes verified: PASS")
...
print("=" * 70)
print("[PASS] Full save produces archive: PASS")
print("[PASS] Archive failure causes full save failure (fail-closed): PASS")
print("[PASS] Essential save succeeds without archive: PASS")
print("[PASS] Error payload contains archive failure message: PASS")
print("[PASS] Success payload suppressed on archive failure: PASS")
print("[PASS] No false success emitted: PASS")

print("\n" + "=" * 70)
print("STEP 4.3 VERDICT")
print("=" * 70)
print("\n[PASS] Forced archive failure causes explicit save failure: PASS")
print("[PASS] Essential save behavior unchanged: PASS")
print("[PASS] Fail-closed behavior verified: PASS")
print("\n" + "=" * 70)
print("STEP 4.3: PASS")
print("=" * 70)
