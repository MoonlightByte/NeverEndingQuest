...
if __name__ == "__main__":
    ...
    if all_passed:
        ...
        print("=" * 70)
        print("\nSummary:")
        print("  ✓ Forced archive failure causes full save to fail (fail-closed)")
        print("  ✓ Essential save succeeds regardless of archive issues")
        print("  ✓ Web interface fail-closed logic works correctly")
        print("  ✓ Success and failure produce different outcomes")
        print("  ✓ No false success message on archive failure")
        print("\nStep 4.3: PASS")
        sys.exit(0)
    else:
