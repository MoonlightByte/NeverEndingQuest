...
Source: core/generators/npc_builder.py:126
Model: NPC_BUILDER_MODEL=>gpt-5.2
Scope: runtime
...
# Task metadata
TASK_ID = "T035"
SOURCE_FILE = "core/generators/npc_builder.py"
SOURCE_LINE = 126
MODEL_EXPR = "NPC_BUILDER_MODEL=>gpt-5.2"
SCOPE = "runtime"
FUNCTION_CONTEXT = "generation_function (in npc_builder.py)"
