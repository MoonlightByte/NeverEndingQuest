"""
Validator for T079: updates/update_character_info.py:1453
Regenerated with correct schema from audit 2026-02-22

Purpose: Character info update response - delta changes only
...
EXPECTED_SCHEMA = {'description': 'Character info update response - delta changes only', 'type': 'object', 'properties': {'currency': {'type': 'object', 'required': ['gold', 'silver', 'copper'], 'properties': {'gold': {'type': 'integer'}, 'silver': {'type': 'integer'}, 'copper': {'type': 'integer'}}}}}
