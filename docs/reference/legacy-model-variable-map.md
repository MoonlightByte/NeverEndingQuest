...
|---|---|---|---|---|
| DM_MAIN_MODEL | gpt-4.1-2025-04-14 | 17 | ~~T013~~(DONE),T022-T028,T031,T036,T037,T046,T059,T063,T064,T092 | Main DM narration, transitions, generators, stitching |
| DM_FULL_MODEL | gpt-4.1-2025-04-14 | 0 dedicated | (used dynamically by T067 via selected_model) | Complex actions requiring JSON operations |
| DM_VALIDATION_MODEL | gpt-4.1-2025-04-14 | 3 | T040,T048,T065 | AI response validation, combat validation |
...
| ACTION_PREDICTION_MODEL | gpt-4.1-2025-04-14 | 1 | T082 | Predicting player action types |
| LOCATION_COMPRESSION_MODEL | gpt-4.1-2025-04-14 | 1 | T085 | Location data compression |
| DM_EFFECTS_MODEL | gpt-4.1-2025-04-14 | 1 | T078 | Character effect tracking |
...
| NARRATIVE_COMPRESSION_MODEL | gpt-4.1-mini-2025-04-14 | 3 | T017,T020,T084 | Narrative/combat/incremental compression |
...
| PLAYER_INFO_UPDATE_MODEL | gpt-4.1-mini-2025-04-14 | 1 | T079 | Player character data updates (dynamic selection) |
