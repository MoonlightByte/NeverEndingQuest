...
#### Scenario: Maelo gifts named items to named party members
- **GIVEN** the current scene includes `Spirit-Touched Hermit Maelo`
- **AND** narration explicitly states that Chronos and Blairen receive ward stones, Vitreol receives the tome, and Scout Kira receives the healing potion
