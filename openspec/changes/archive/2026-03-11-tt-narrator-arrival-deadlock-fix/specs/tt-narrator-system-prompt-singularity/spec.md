...
# Spec: tt-narrator-system-prompt-singularity
# Capability: Narrator System Prompt Singularity
...
### Requirement: Other system context messages are preserved

World state, location, plot, and DM note context SHALL remain present after dedupe.
