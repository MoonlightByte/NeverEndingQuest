...
Ensure upload job status responses expose explicit artifact manifests so operators and developers can see which workspace artifacts exist for any job without inspecting the filesystem.
