...
- [X] 7.5 Perform manual smoke validation: play without clicking Save, press explicit GUI Exit, restart with Start Game, confirm the Diary timeline now contains a confirmed entry and Story So Far can build from it without requiring a manual save.
