...
Provide clear, contextual UX guidance for `backgroundFeature.name` and `backgroundFeature.description` fields so players can confidently fill background feature values without external rules lookup.
