...
Define requirements for Many Worlds save/restore parity with memory DB state, ensuring memory snapshots are captured and restored alongside JSON gameplay state.
