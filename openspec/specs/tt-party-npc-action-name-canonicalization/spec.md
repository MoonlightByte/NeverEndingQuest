# tt-party-npc-action-name-canonicalization Specification

## Purpose

Define canonicalization behavior for party-NPC action payload names to enable short-name aliases while maintaining validation integrity.
