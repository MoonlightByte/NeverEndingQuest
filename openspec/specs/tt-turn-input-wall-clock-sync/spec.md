# tt-turn-input-wall-clock-sync Specification

## Purpose
TBD - created by archiving change tt-turn-synced-world-time-and-idle-loop-hardening. Update Purpose after archive.
## Requirements
