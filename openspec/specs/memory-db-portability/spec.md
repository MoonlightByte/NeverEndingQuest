...
The system MUST validate manifest and schema compatibility before importing memory data.
...
Import flow SHALL default to safe behavior and avoid overwriting existing DB without explicit operator override.
