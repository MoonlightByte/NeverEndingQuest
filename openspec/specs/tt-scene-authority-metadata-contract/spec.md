# tt-scene-authority-metadata-contract Specification

## Purpose
TBD - created by archiving change tt-scene-authority-metadata-generalization. Update Purpose after archive.
## Requirements
