...
Enforce single active tabletop combat encounter ownership across action handling and runtime session startup to prevent duplicate unresolved combat sessions.
