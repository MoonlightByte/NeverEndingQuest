...
Ensure defeated non-player combatants converge to a single authoritative mechanical truth across encounter persistence, multi-PC turn state, target resolution, and initiative UI visibility.
