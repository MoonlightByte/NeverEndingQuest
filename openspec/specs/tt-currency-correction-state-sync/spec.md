# tt-currency-correction-state-sync Specification

## Purpose
TBD - created by archiving change tt-currency-inventory-correction-state-sync. Update Purpose after archive.
## Requirements
